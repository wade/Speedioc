...
namespace Speedioc
{
	...
	/// </summary>
	[Serializable]
	public class RegistrationValidationException : SpeediocException
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="RegistrationValidationException"/> class without a message.
		/// </summary>
		...
		public RegistrationValidationException(string message, Exception innerException)
			: base(message, innerException)
		{
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="RegistrationValidationException" /> class with the specified formatted error message.
		/// </summary>
		/// <param name="message">
		/// A human-readable description of the error. 
		/// The caller of this constructor is required to ensure that this string has been localized for the current system culture.
		...
		public RegistrationValidationException(string message, object arg0)
		...
		public RegistrationValidationException(string message, object arg0, object arg1)
		...
		public RegistrationValidationException(string message, object arg0, object arg1, object arg2)
		...
		public RegistrationValidationException(string message, params object[] args)
			: base(string.Format(message, args))
		{
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="RegistrationValidationException" /> class with the specified error message.
		/// </summary>
		/// <param name="innerException">The exception that is the cause of the current exception.</param>
		/// <param name="message">
		/// A human-readable description of the error. 
		/// The caller of this constructor is required to ensure that this string has been localized for the current system culture.
		/// </param>
		public RegistrationValidationException(Exception innerException, string message)
			: base(message, innerException)
		{
		}
		...
		/// </param>
		/// <param name="arg0">The object to write using the error message format.</param>
		public RegistrationValidationException(Exception innerException, string message, object arg0)
		...
		/// <param name="arg0">The first object to write using the error message format.</param>
		/// <param name="arg1">The second object to write using the error message format.</param>
		public RegistrationValidationException(Exception innerException, string message, object arg0, object arg1)
		...
		/// <param name="arg1">The second object to write using the error message format.</param>
		/// <param name="arg2">The third object to write using the error message format.</param>
		public RegistrationValidationException(Exception innerException, string message, object arg0, object arg1, object arg2)
		...
		/// </param>
		/// <param name="args">An array of objects to write using the error message format.</param>
		public RegistrationValidationException(Exception innerException, string message, params object[] args)
			: base(string.Format(message, args), innerException)
		{
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="RegistrationValidationException" /> class with serialized data.
		/// </summary>
		...
		/// </remarks>
		protected RegistrationValidationException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
	}
